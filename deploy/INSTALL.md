...
Public **Emissary** (`emissary kb-web`) + static portal on this server (`archon`, 74.208.222.204),
...
3. Put the Warden DID into the Emissary env file:
...
- KB id: `hearthold-kb`  ·  Emissary bridge: `127.0.0.1:4313` (loopback only)
