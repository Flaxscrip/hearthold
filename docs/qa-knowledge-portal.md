...
- [ ] **E3** Member goes to **Contribute**, adds a fact (e.g. kind `event`: *"Our community meets Thursdays at 8pm."*).
...
- [ ] **E4** Member asks *"When does the community meet?"* → answers from their own contribution.
