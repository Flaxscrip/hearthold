...
- **(b) crosses a publication boundary** — it makes content or an identifier reach a party beyond this node
  (disclosure to a community's members, gossip onto a shared topic, an outward credential);
...
|---|---|---|---|---|
| **Publish to a community** (with peers) | ✓ (members receive it; can't un-send) | ✓ | — | **Yes** (a+b) |
...
- **into a community WITH peers** — the community's members will *receive what we import* → this is **publication**
...
(3) Should (b) distinguish "publication to N known members of a community" from "gossip to an open topic"? The
