...
Sovereign** and the Witness + Warden automating the Traveler Profile.
...
|---|---|
| no AI-agent identity / present-on-behalf | the **Witness** (projects under scoped delegation) |
...
| **AI Travel Agent (VTA)** — *presents / coordinates* | **Witness** (projects under delegation) |
...
The demo's single "AI Agent" splits cleanly into our **Witness (projects) + Warden (custodies)** —
a refinement, not a mismatch. "Witness + Warden automate building the profile" = the Witness
...
2. **Credential ingestion via the Witness** — the Witness receives a provider's VC in the world and
